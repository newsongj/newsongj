...
from app.crud.member import get_members, get_deleted_members, resolve_leader_names, create_member, delete_member, restore_member, build_member_row, modify_member
from app.schemas.member import DeletedMemberListResponse, DeletedMember, MemberListResponse, MemberRow, PageMeta, MemberDeleteState, AddMember, MemberIdResponse
...
def restore_member(
    ...
    member = restore_member(db, member_id)
    return build_member_row(member, None, db)
