...
const commonTheme: CustomBase = {
    typography: {
        hero:     { fontSize: '50px', fontWeight: 700, lineHeight: '65px' },
        h1:       { fontSize: '38px', fontWeight: 700, lineHeight: '49px' },
        h2:       { fontSize: '28px', fontWeight: 700, lineHeight: '36px' },
        h3:       { fontSize: '22px', fontWeight: 700, lineHeight: '33px' },
        subtitle: { fontSize: '18px', fontWeight: 700, lineHeight: '27px' },
        body1:    { fontSize: '16px', fontWeight: 400, lineHeight: '24px' },
        body2:    { fontSize: '14px', fontWeight: 400, lineHeight: '21px' },
        button:   { fontSize: '14px', fontWeight: 500, lineHeight: '16px' },
        caption:  { fontSize: '12px', fontWeight: 400, lineHeight: '18px' },
    },
    colors: {
        primary: {
            _050: '#E6F1FD', _100: '#B5D6FB', _200: '#85BBF9', _300: '#54A0F6',
            _400: '#2385F4', _500: '#187EF4', _600: '#095FC2', _700: '#064792',
            _800: '#042F61', _900: '#021730',
            variant: '#064792', container: '#E6F1FD', outline: 'rgba(93, 96, 100, 0.12)',
        },
        neutral: {
            _00: '#000000', _10: '#1C1E21', _20: '#2F3235', _30: '#46494C',
            _40: '#5D6064', _50: '#76797D', _60: '#8F9296', _70: '#A9ADB1',
            _80: '#C5C9CD', _90: '#E0E4E9', _95: '#EFF3F7', _99: '#FBFDFF', _100: '#FFFFFF',
        },
        text:          { high: 'rgba(0,0,0,0.87)', medium: '#5D6064', disabled: '#A9ADB1' },
        textOnPrimary: { high: '#ffffff', medium: '#dddddd', disabled: '#bbbbbb' },
        background: '#f5f5f5', surface: '#ffffff',
        error: '#FAF0F3', success: '#E1FCEF', warning: '#FCF2E6', info: '#F0F1FA',
        active: '#E6F1FD', inactive: '#E9EDF5', white: '#ffffff', black: '#000000',
        on: {
            primary: '#ffffff', background: '#111111', surface: '#111111',
            error: '#ff4d4f', success: '#52c41a', warning: '#faad14',
            info: '#1890ff', active: '#1d78ff', inactive: '#cccccc',
        },
    },
    borderRadius: '8px',
    spacing: { xs: '8px', sm: '12px', md: '16px', lg: '24px', xl: '32px', xxl: '40px' },
    overlay: {
    ...
    transitions: { fast: '0.15s ease-in-out', normal: '0.3s ease-in-out', slow: '0.5s ease-in-out' },
    zIndices:    { modal: 1000, overlay: 900, dropdown: 800, header: 700 },
    opacity:     { _08: 0.08, _12: 0.12, _16: 0.16, _38: 0.38, _60: 0.60, _87: 0.87 },
};

export const lightTheme: DefaultTheme['custom'] = { mode: 'light', ...commonTheme };
export const darkTheme:  DefaultTheme['custom'] = { mode: 'dark',  ...commonTheme };
