...
export const StyledInputContainer = styled('div', {
  ...
  return {
    ...
    ...sizeStyles,
    ...$hasLeadingIcon && { paddingLeft: theme.custom.spacing.md },
    ...$hasTrailingIcon && { paddingRight: theme.custom.spacing.md },
  };
});
...
export const StyledTextArea = styled(TextField, {
  ...
  return {
    ...
    '& .MuiInputBase-input': {
      padding: 0,
      width: '100%',
      '&::placeholder': { color: theme.custom.colors.text.medium, opacity: 1 },
      '&:disabled': { color: theme.custom.colors.text.disabled, cursor: 'not-allowed' },
    },
    '& .MuiOutlinedInput-notchedOutline': { border: 'none' },
    '& .MuiInputBase-inputMultiline': { padding: 0, resize: 'vertical', width: '100%' },
  };
});
...
export const StyledLabel = styled('label', {
  ...
  theme, $variant, $error, $disabled, $focused, $hasValue, $disableAnimation
}) => ({
  position: 'absolute',
  ...
  ...$disabled && { opacity: theme.custom.opacity._38 },
}));
...
export const StyledHelperText = styled('div', {
  ...
  lineHeight: theme.custom.typography.caption.lineHeight,
  fontWeight: 600,
  color: $error ? theme.custom.colors.on.error : theme.custom.colors.text.high,
  opacity: 1,
  ...$disabled && { opacity: theme.custom.opacity._38 },
}));
