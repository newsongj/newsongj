...
export const StyledButton = styled(MuiButton, {
  ...
  ...($variant === 'filled' && {
    ...
    '&:hover': {
      ...
      '&::before': { backgroundColor: 'rgba(255,255,255,0.08)' },
    },
    '&:focus': {
      backgroundColor: theme.custom.colors.primary._500,
      '&::before': { backgroundColor: 'rgba(255,255,255,0.12)' },
    },
    '&:active': {
      backgroundColor: theme.custom.colors.primary._500,
      '&::before': { backgroundColor: 'rgba(255,255,255,0.12)' },
  ...
  ...($variant === 'elevated' && {
    ...
    '&:hover': {
      ...
      '&::before': { backgroundColor: 'rgba(24,126,244,0.08)' },
    },
    '&.Mui-disabled': {
      backgroundColor: 'rgba(0,0,0,0.12)',
      color: theme.custom.colors.text.disabled,
  ...
  ...($variant === 'text' && {
    ...
    backgroundColor: 'transparent',
    border: 'none',
    '&:hover': { '&::before': { backgroundColor: 'rgba(24,126,244,0.08)' } },
